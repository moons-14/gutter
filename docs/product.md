...
and duplicate-locator archives are quarantined. M3 #20 validation covers an opaque,
network-only worker descriptor/page boundary with bounded route-local page bytes and mobile
interactions. It retains only browser-local presentation and revision-aware progress; there is no
